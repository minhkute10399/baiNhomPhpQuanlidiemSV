			...
			<div class="col-sm-12 push-sm-3 form-group">
				...
				<form action="<?= base_url() ?>Diem/add" method="post">
					...
					<fieldset class="form-group form-control">
						...
						<input type="text" class="form-control form-group" name="lanhoc" placeholder="Nhập lần học">
					</fieldset>

					<fieldset class="form-group form-control">
						<label style="color: #E91E63">Lần Thi:</label>
						<input type="text" class="form-control form-group" name="lanthi" placeholder="Nhập lần thi">
					</fieldset>
					...
					<fieldset class="form-group form-control">
						...
						<!-- <.?php 
							$total == float($diemcc*0.1 + ((($diemgk+$diemthuchanh)/2)*0.2) + $diemketthuc*0.7);
						 ?> -->
					</fieldset>
									...
									<tbody>
											...
											<?php foreach ($data_diem as $value): ?>
												...
												|
													...
													<td class="table-active"><?= $value['lanhoc'] ?></td>
													<td class="table-active"><?= $value['lanthi'] ?></td>
