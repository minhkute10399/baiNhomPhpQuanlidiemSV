		...
		<div class="row">
			<div class="col-sm-4 push-sm-3">
				<div class="alert alert-success ; text-center">
					<strong>Hệ Đào Tạo</strong>
				</div>

				<form action="<?= base_url() ?>HeDaoTao/add" method="POST">

				<fieldset class="form-group form-control">
					<label style="color: #E91E63">Mã Hệ Đào Tạo:</label>
					<input type="text" class="form-control form-group" placeholder="Nhập mã hệ đào tạo" name="mahedaotao">
				</fieldset>

				<fieldset class="form-group form-control">
					<label style="color: #E91E63">Tên Hệ Đào Tạo:</label>
					<input type="text" name="tenhedaotao" placeholder="Nhập tên hệ đào tạo" class="form-control form-group">
				</fieldset>
			...
			<div class="col-sm-8 push-sm-3">
				<div>
					<div class="alert alert-success text-center">
						<strong>Danh Sách Hệ Đào Tạo</strong>
					</div>
				</div>
							...
							<tbody>
								...
								<?php foreach ($data_hedaotao as $value): ?>
									<tr>
										...
										<a class="zmdi zmdi-edit" href="<?= base_url() ?>HeDaoTao/laydulieu/<?= $value['id'] ?>"></a>
									|
										<a style="color: red ; height: 50px" class="zmdi zmdi-delete" color="red" href="<?= base_url() ?>HeDaoTao/delete/<?= $value['id'] ?>"></a>
										</td>
										<td class="table-active"><?= $i ?></td>
										<td class="table-active"><?= $value['mahedaotao'] ?></td>
										<td class="table-active"><?= $value['tenhedaotao'] ?></td>
									</tr>
									<?php $i++ ?>
								<?php endforeach ?>
